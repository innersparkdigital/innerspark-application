...
export default function GenericScreen({ navigation }){
            ...
            <ImageBackground source={appImages.laundryBg} style={{ flex: 1, }}>
                ...
                <View style={{ flex:1, justifyContent:'center', alignItems:'center'}}>
                    <View style={{ paddingVertical:15 }}>
                        <Icon type="material-icons" name="local-laundry-service" color={appColors.AppBlue} size={80} /> 
                    </View>
                    <Text style={{ fontSize:20, color:appColors.AppBlue, fontWeight:'700' }}>Generic Screen</Text>
