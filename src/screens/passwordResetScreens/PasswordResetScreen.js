                        ...
                        <View style={{ flex: 1, paddingHorizontal: scale(20), paddingVertical: verticalScale(30) }}>
                            ...
                            <View style={{ paddingVertical: verticalScale(2) }}>
                                ...
                                <View style={{ justifyContent: 'center', alignItems: 'center', paddingVertical: verticalScale(20), paddingHorizontal: scale(10) }}>
                                    <Text style={{ fontSize: moderateScale(28), color: appColors.AppBlue, fontWeight: 'bold', paddingVertical: verticalScale(5) }}>Reset Password</Text>
                                    <Text style={{ fontSize: moderateScale(15), color: appColors.AppBlue, fontWeight: '400', paddingVertical: verticalScale(5), textAlign: 'center' }}>
                            ...
                            <View style={{ paddingVertical: verticalScale(15) }}>
                                ...
                                {isLoading &&
                                    <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: verticalScale(10) }}>
                                        <ActivityIndicator style={{ marginHorizontal: scale(5) }} />
                                        <Text style={{ color: appColors.black, fontSize: moderateScale(14) }}>Requesting Password Reset...</Text>
                                    </View>
                                }
