...
const styles = StyleSheet.create({
  ...
  sectionHeader: {
    ...
    alignItems: 'center',
    marginBottom: 12,
    paddingHorizontal: scale(20), // ADDED: Padding for the whole header row
    marginTop: scale(20),
  },
  sectionTitle: {
    ...
    letterSpacing: 0.5,
    // REMOVED: marginHorizontal: scale(20),
    // REMOVED: marginTop: scale(20),
    marginBottom: scale(10),
  },
  addButton: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: appColors.AppBlue + '15', // Subtle blue background
    paddingHorizontal: scale(12),
    paddingVertical: scale(6),
    borderRadius: scale(20),
    // REMOVED: marginHorizontal: scale(20),
    // REMOVED: marginVertical: scale(20),
  },
  addButtonText: {
