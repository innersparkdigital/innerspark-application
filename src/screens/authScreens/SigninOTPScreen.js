                ...
                <View style={{ flex: 1, paddingVertical: scale(20) }}>
                    <View style={styles.OPTContainer}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', paddingVertical: scale(10) }}>
                            <Text style={{ fontSize: moderateScale(26), color: appColors.AppBlue, fontWeight: 'bold', paddingVertical: scale(5) }}>Verify {isEmailLoginType(loginData.type) ? "Email" : "Phone"}</Text>
                            <Text style={{ fontSize: moderateScale(14), color: appColors.AppBlue, fontWeight: '400', paddingVertical: scale(5), textAlign: 'center' }}>
                        ...
                        {isLoading &&
                            <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                                ...
                                <Text style={{ color: appColors.AppBlue, fontSize: moderateScale(14) }}>Checking OTP...</Text>
                            </View>
                        }

                        {/* Resend OTP Code */}
                        <View style={{ paddingVertical: scale(5), alignItems: 'center', flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            {isReloadingOTP &&
                                <View style={{ justifyContent: 'center', paddingVertical: scale(5) }}>
