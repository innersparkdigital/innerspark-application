    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          <Icon name="shield-checkmark" type="ionicon" color={appColors.AppBlue} size={moderateScale(48)} />
        ...
        <Section title="11. Contact Us">
          ...
          <View style={styles.contactBox}>
            ...
            <View style={styles.contactRow}>
              <Icon name="language" type="material" color={appColors.AppBlue} size={moderateScale(20)} />
              <Text style={styles.contactText}>www.innersparkafrica.com</Text>
            </View>
            <View style={styles.contactRow}>
              <Icon name="location-on" type="material" color={appColors.AppBlue} size={moderateScale(20)} />
        ...
        <View style={styles.footer}>
          <Icon name="verified-user" type="material" color={appColors.grey4} size={moderateScale(16)} />
